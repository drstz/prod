...
//  Prod
//
//  Created by Duane Stoltz on 28/11/2016.
...
struct Theme {
    ...
    var normalColor = UIColor(red: 40/255, green: 82/255, blue: 108/255, alpha: 1)
    ...
    var backgroundColor = UIColor(red: 40/255, green: 108/255, blue: 149/255, alpha: 1)
    var tintColor = UIColor(red: 40/255, green: 108/255, blue: 149/255, alpha: 1)
    
    var switchTintColor = UIColor(red: 68/255, green: 140/255, blue: 183/255, alpha: 1)
    
    var normalTextColor = UIColor.white
    var selectionColor = UIColor(red: 148/255, green: 191/255, blue: 215/255, alpha: 1)
}
